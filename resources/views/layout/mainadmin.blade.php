            ...
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Data Induk</span></a>
					    <ul class="pcoded-submenu">
                            <li><a href="{{url('admin/data-mapel')}}">Data Mata Pelajaran</a></li>
                            ...
                            <li><a href="{{url('admin/data-kelas-belajar')}}">Data Kelas belajar</a></li>
					    </ul>
					</li>
                    <li class="nav-item">
                        <a href="{{route('admin.jadwal')}}" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-home"></i></span><span class="pcoded-mtext">Jadwals</span></a>
                    </li>
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{asset('admin/assets/images/user/avatar-1.jpg')}}" class="img-radius"
                                    alt="User-Profile-Image">
                                <span>John Doe</span>
                                <a href="{{route('admin.login')}}" class="dud-logout" title="Logout">
